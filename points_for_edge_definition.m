function [waypoints, headings, curvatures] = points_for_edge_definition(Center_line)
         ...
         %for smin = 1:Center_line.length()
           ...
           if(next_wayline<Center_line.length()) 
            ...
            %     plot(waypoint_left(1,1), waypoint_left(2,1), 'x');
                ...
                waypoints_temp = {waypoint_right; waypoint_left};
